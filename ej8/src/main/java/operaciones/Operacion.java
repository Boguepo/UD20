...
public class Operacion implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		//para validar que boton se ha clickado uso la funcion getActionCommand que me dice el nombre del boton que se ha pulsado
		...
		if(v.getCambiar().getText() == e.getActionCommand()) {
			...
			try {
				...
				v.getResultado().setText(Double.toString(result));
			}else {
